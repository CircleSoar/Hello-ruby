...
class AboutArrays < Neo::Koan
  def test_creating_arrays
    ...
    assert_equal Array, empty_array.class  #assert_equal即为等于的意思
  ...
  #https://stackoverflow.com/questions/3219229/why-does-array-slice-behave-differently-for-length-n
